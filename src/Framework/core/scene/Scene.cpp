...
namespace HsEngine
{
    ...
    void Scene::OnKeyDown (const osgGA::GUIEventAdapter::KeySymbol& inputKey)
    {
        switch (inputKey)
        {
            case osgGA::GUIEventAdapter::KeySymbol::KEY_Escape:
                SceneManager::GetInstance()->GetViewer()->setDone (true);
                break;
        }
    }
