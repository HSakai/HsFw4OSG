...
namespace HsEngine
{
    ...
    void SceneManager::OnKeyDown (const osgGA::GUIEventAdapter::KeySymbol& inputKey)
    {
        ...
        currentScene->OnKeyDown (inputKey);
    }
    ...
    osgViewer::Viewer* SceneManager::GetViewer ()
    {
        return viewer;
    }

    SceneManager::SceneManager ()
        : sceneMngParam (nullptr), rootScene (nullptr), currentScene (nullptr), viewer (new osgViewer::Viewer ())
    {
        viewer->setThreadingModel(osgViewer::Viewer::SingleThreaded);
        viewer->addEventHandler(new osgViewer::StatsHandler ());
        viewer->addEventHandler (new HsEngine::KeyEventHandler ());
        viewer->realize();
    }
